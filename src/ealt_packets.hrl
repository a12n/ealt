...
-define(CAR_PACKET_RACE_SECTOR_1_TIME, 7).
-define(CAR_PACKET_RACE_PIT_LAP_1, 8).
-define(CAR_PACKET_RACE_SECTOR_2_TIME, 9).
-define(CAR_PACKET_RACE_PIT_LAP_2, 10).
-define(CAR_PACKET_RACE_SECTOR_3_TIME, 11).
...
-define(CAR_PACKET_PRACTICE_BEST_TIME, 4).
-define(CAR_PACKET_PRACTICE_GAP, 5).
-define(CAR_PACKET_PRACTICE_SECTOR_1_TIME, 6).
-define(CAR_PACKET_PRACTICE_SECTOR_2_TIME, 7).
-define(CAR_PACKET_PRACTICE_SECTOR_3_TIME, 8).
...
-define(CAR_PACKET_QUALIFYING_SECTOR_1_TIME, 7).
-define(CAR_PACKET_QUALIFYING_SECTOR_2_TIME, 8).
-define(CAR_PACKET_QUALIFYING_SECTOR_3_TIME, 9).
